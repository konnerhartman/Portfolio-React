  ...
  return (
    <div class="container ms-0 ps-0">
        <div class="row">
            ...
            <div class="accordion my-5 d-none" id="accordionExample">
                <h2 class="text-center fw-bold">About Me</h2>
                <div>
                    <div class="card-header bg-dark" id="headingOne">
                        <h2 class="mb-0">
                        <button class="btn btn-link collapsed text-white text-decoration-none px-5" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            My Past
                        </button>
                        </h2>
                    </div>
                ...
                <div class="">
                    <div class="card-header bg-dark" id="headingTwo">
                        <h2 class="mb-0">
                        <button class="btn btn-link collapsed text-white text-decoration-none px-5" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            My Present
                        </button>
                        </h2>
                    </div>
                ...
                <div class="">
                    <div class="card-header bg-dark" id="headingThree">
                        <h2 class="mb-0">
                        <button class="btn btn-link collapsed text-white text-decoration-none px-5" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            My Future
                        </button>
                        </h2>
                    </div>
